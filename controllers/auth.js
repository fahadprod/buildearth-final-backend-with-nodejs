...
exports.register = (req, res) => {
    ...
    const { firstName, lastName, email, password, address, cellPhone, cnicNumber, city, country, role } = req.body;
    ...
    User.findOne({ email }).exec((err, user) => {
        ...
        const token = jwt.sign({ firstName, lastName, email, password, address, cellPhone, cnicNumber, city, country, role }, process.env.JWT_ACCOUNT_ACTIVATION, {
            expiresIn: '10m'
        });
...
exports.registerActivate = (req, res) => {
    ...
    jwt.verify(token, process.env.JWT_ACCOUNT_ACTIVATION, function(err, decoded) {
        ...
        const { firstName, lastName, email, password, address, cellPhone, cnicNumber, city, country, role } = jwt.decode(token);
        ...
        User.findOne({ email }).exec((err, user) => {
            ...
            // register new user
            const newUser = new User({ firstName, lastName, email, password, address, cellPhone, cnicNumber, city, country, role });
